...
/obj/item/areaeditor/blueprints
	...
	desc = "Blueprints of the city. There is a \"Classified\" stamp and several blood stains on it."
	icon = 'icons/obj/items_and_weapons.dmi'
	icon_state = "blueprints"
	fluffnotice = "Property of Skavenblight. For heads of clan only. Store in high-secure storage."
...
/obj/item/areaeditor/blueprints/cyborg
	name = "city schematics"
	desc = "A copy of the cities blueprints stored in your memory."
	icon = 'icons/obj/items_and_weapons.dmi'
	icon_state = "blueprints"
	fluffnotice = "Intellectual Property of Skavenblight. For use in Skaven-brainmeat only. Wipe from memory upon departure from the city."
