...
/proc/curse_of_madness(mob/user, message)
	...
	deadchat_broadcast("A <span class='name'>Curse of Madness</span> has stricken the city, shattering their minds with the awful secret: \"<span class='big hypnophrase'>[message]</span>\"", message_type=DEADCHAT_ANNOUNCEMENT)
